...
class Ref_kurikulum extends CI_Controller {
	function index(){
		//cek_session_admin();
 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->set_table('ref_kurikulum');
			$crud->set_subject('Kurikulum');
			$crud->required_fields('nama_kurikulum');
			$crud->columns('kode_kurikulum','nama_kurikulum');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','ref_kurikulum/mod_menu/view_menu',$output);
