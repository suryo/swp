 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->required_fields('nama_group');
			$crud->columns('level_id','nama_group');
			$crud->display_as('level_id','Kode Group');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','user_group/mod_menu/view_menu',$output);
