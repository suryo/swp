...
class Examples extends CI_Controller {
	...
	public function index()
	{
		...
		$crud->columns('nama','fk_id_prov','nama_prov','fk_id_kota','fk_id_kec','fk_id_kel');
		...
		$crud->set_relation('fk_id_prov','provinsi','id_prov');
		...
		// Field Kabupaten
		'nama_prov' => array( // second dropdown name
		'table_name' => 'provinsi', // table of state
		'title' => 'nama', // state title
		'id_field' => 'id_prov', // table of state: primary key
