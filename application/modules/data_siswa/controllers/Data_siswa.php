 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->columns('nis','nama','jenis_kelamin', 'tempat_lahir', 'tgl_lahir','agama','foto');
			$crud->required_fields('nis','nama','jenis_kelamin','tempat_lahir','tahun_masuk','kelas');
			
			//$crud->set_relation_n_n('group', 'detail_user_group', 'user_group', 'username', 'level_id', 'nama_group','priority');
			//$crud->required_field('nis');
			$crud->set_subject('Siswa');
			
			//$crud->change_field_type('password','password');
			//$crud->callback_before_insert(array($this,'encrypt_password_callback'));
			//$crud->callback_before_update(array($this,'encrypt_password_callback'));
			//$crud->set_relation('level_id', 'user_group', 'nama_group');
			$crud->set_field_upload('foto','asset/foto_user/');

			//$crud->required_fields('email');
//			$crud->columns('email','password','level_id');
			//$crud->change_field_type('password_field','password');
			//$crud->set_relation_n_n('menu', 'menu_user_group', 'menu', 'kode_group', 'id_menu', 'nama_menu','priority');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','Data_siswa/mod_menu/view_menu',$output);
