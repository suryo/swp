...
class Ref_status_kepegawaian extends CI_Controller {
	function index(){
		//cek_session_admin();
 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->set_table('ref_status_kepegawaian');
			$crud->set_subject('Status Kepegawaian');
			$crud->required_fields('jenis_ptk');
			$crud->columns('id_status_kepegawaian','status_kepegawaian');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','ref_kelas/mod_menu/view_menu',$output);
