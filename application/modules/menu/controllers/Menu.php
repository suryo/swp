 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->required_fields('nama_menu');
			$crud->columns('id_parent','nama_menu','link', 'aktif', 'frontback');
			$crud->order_by('id_menu','asc');
			$crud->set_relation('id_parent','menu','nama_menu');
