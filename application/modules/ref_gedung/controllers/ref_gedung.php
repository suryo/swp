...
class Ref_gedung extends CI_Controller {
	function index(){
		//cek_session_admin();
 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->set_table('ref_gedung');
			$crud->set_subject('Gedung');
			$crud->required_fields('nama_gedung');
			$crud->columns('kode_gedung','nama_gedung','jumlah_lantai','aktif');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','ref_gedung/mod_menu/view_menu',$output);
