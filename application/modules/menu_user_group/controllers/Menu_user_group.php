...
class Menu_user_group extends CI_Controller {
	function index(){
		//cek_session_admin();
 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->set_table('menu_user_group');
			$crud->columns('kode_group','id_menu','canAdd', 'canEdit','canDelete');
			$crud->display_as('id_menu','Nama menu');
			$crud->set_subject('Menu User Group');
			$crud->set_relation('id_menu','menu','nama_menu')
				 ->set_relation('kode_group','user_group','nama_group');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','menu/mod_menu/view_menu',$output);
