...
class Dimensi_pilar extends CI_Controller {
	function index(){
		//cek_session_admin();
 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->set_table('dimensi_pilar');
			$crud->set_subject('Dimensi Pilar');
			$crud->required_fields('nama_dimensi');
			$crud->set_relation('id_pilar','pilar_budi_pekerti','nama_pilar');
			$crud->columns('id_dimensi','id_pilar','nama_dimensi');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','lokasi_amatan/mod_menu/view_menu',$output);
