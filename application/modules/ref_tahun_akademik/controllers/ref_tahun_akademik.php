 ...
 public function tabelCRUD()
	{
		...
		try{
			...
			$crud->set_table('ref_tahun_akademik');
			$crud->set_subject('Tahun Akademik');
			$crud->required_fields('nama_tahun');
			$crud->columns('id_tahun_akademik','nama_tahun','keterangan','aktif');
	...
	public function _example_output($output = null)
	{
		...
		$this->template->load('administrator/template','ref_tahun_akademik/mod_menu/view_menu',$output);
